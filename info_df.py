...
data_con = get_dataframe_from_bigquery('info21', 'bid_con_df_listup')
data_ser = get_dataframe_from_bigquery('info21', 'bid_ser_df_listup')
data_pur = get_dataframe_from_bigquery('info21', 'bid_pur_df_listup')
